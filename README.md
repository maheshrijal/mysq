...
[![mysq overview showing database health and live query, thread, lock-wait, and InnoDB I/O graphs](docs/images/mysq-overview.png)](docs/images/mysq-overview.png)
